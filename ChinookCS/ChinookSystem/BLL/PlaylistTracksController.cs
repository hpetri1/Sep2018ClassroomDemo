...
namespace ChinookSystem.BLL
{
    public class PlaylistTracksController
    {
        ...
        //the method requires the design to properly design a solution BEFORE attempting to code
        public void Add_TrackToPLaylist(string playlistname, string username, int trackid)
        {
            ...
            //all errors can hen be returned to the MessageUsageControl
            ...
            using (var context = new ChinookContext())
            {
                //code to go here
                //Part One
                //determine is a new playlist is needed
                //determine the tracknumber dependent of if a playlist already exists.
                Playlist exists = context.Playlists
                    .Where(x => x.UserName.Equals(username) && x.Name.Equals(playlistname, StringComparison.OrdinalIgnoreCase))
