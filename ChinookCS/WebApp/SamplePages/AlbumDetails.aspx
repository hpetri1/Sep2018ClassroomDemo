...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <asp:GridView ID="TracksOfAlbums" runat="server" 
            DataSourceID="AlbumTrackODS" AutoGenerateColumns="false" AllowPaging="true" OnSelectedIndexChanged="TracksOfAlbums_SelectedIndexChanged">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Media">
                    <ItemTemplate>
                        <asp:Label Text='<%# Eval("MediaTypeId") %>' runat="server" ID="MediaTypeLabel" />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Composer">
                    ...
                    <ItemTemplate>
                        <asp:Label Text='<%# Eval("Composer") %>' runat="server" ID="ComposerIdLabel" />
                    </ItemTemplate>
                </asp:TemplateField>
