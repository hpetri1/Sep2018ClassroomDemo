...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>ODS CRUD</h1>
    <blockquote>
        The reference to data using Eval or Bind is dependent on the type of control and the template the reference is used.
        <br />
        For A ODS Delete to be successful you <strong><u>MUST</u></strong> include on the ListView set of attributes the DataKeyNames. This is set to the primary key attribute of the entity.
    </blockquote>
    ...
    <asp:ListView ID="AlbumList" runat="server" DataSourceID="AlbumListODS" InsertItemPosition="LastItem">
        <AlternatingItemTemplate>
            <tr style="background-color: #FFFFFF; color: #284775;">
                ...
                <td>
                    <%--<asp:Label Text='<%# Eval("ArtistId") %>' runat="server" ID="ArtistIdLabel" /> replaced the Label with a dropdown list--%> 
        ...
        <EditItemTemplate>
            <tr style="background-color: #999999;">
                ...
                <td>
                    ...
                    <%--changed here from Eval To Bind--%>
                    <asp:DropDownList ID="ArtistList" runat="server" 
                        DataSourceID="ArtistListODS" 
                        DataTextField="Name"
                        DataValueField="ArtistId"
