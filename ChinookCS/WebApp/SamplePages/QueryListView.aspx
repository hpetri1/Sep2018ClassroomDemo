...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DropDownList ID="ArtistList" runat="server" 
        ...
        DataTextField="Name" 
        DataValueField="ArtistId" AppendDataBoundItems="true">
    ...
    <asp:ListView ID="AlbumList" runat="server" DataSourceID="AlbumListODS">
        <AlternatingItemTemplate>
            <tr style="background-color: #FFFFFF; color: #284775;">
                ...
                <td><asp:DropDownList ID="AlbumArtistList" runat="server" 
                    DataSourceID="ArtistListODS" 
                    DataTextField="Name" 
                    DataValueField="ArtistId"
                    SelectedValue='<%# Eval("ArtistId") %>'></asp:DropDownList></td>
                <td>
                    <asp:Label Text='<%# Eval("ReleaseYear") %>' runat="server" ID="ReleaseYearLabel" /></td>
                <td>
                    <asp:Label Text='<%# Eval("ReleaseLabel") %>' runat="server" ID="ReleaseLabelLabel" /></td>
                <%--<td>
                    <asp:Label Text='<%# Eval("Artist") %>' runat="server" ID="ArtistLabel" /></td> Navigational Property --%>
            </tr>
        </AlternatingItemTemplate>
        <%--Deleted EditItemTemplate here--%>
        <EmptyDataTemplate>
        ...
        <%-- Deleted InsertItemTemplate here --%>
        <ItemTemplate>
                    ...
                    <td runat="server">
                        <table runat="server" id="itemPlaceholderContainer" style="background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;" border="1">
                            <tr runat="server" style="background-color: #E0FFFF; color: #333333;">
                                ...
                                <%--<th runat="server">Artist</th> Navigational Property, but we don't need it here--%>
                            </tr>
                            <tr runat="server" id="itemPlaceholder"></tr> <%--this tr represents a row on your dataset--%>
                        </table>
                    </td>
                </tr>
                <tr runat="server">
        ...
        <%-- Deleted SelectedItemTemplate here --%>
    </asp:ListView>
